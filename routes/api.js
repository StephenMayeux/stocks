...
// ANGULAR CORE.JS USES THIS API ENDPOINT TO DELETE symbols
router.get('/delete/:stock', function(req, res, next) {
  Stock.findOne({name: req.params.stock}, function(err, docs) {
    if (err) {
      throw err;
    } else {
      docs.remove();
